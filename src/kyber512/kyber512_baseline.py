#!/usr/bin/env python3
"""
Kyber-512 + AES-256-GCM Baseline System
Smaller Kyber variant for comparison
"""
...
class Kyber512Baseline:
    """Kyber-512 + AES-256-GCM system"""
    ...
    def __init__(self):
        ...
        print(f"✓ Initialized {self.kem_algorithm} + AES-256-GCM baseline")
    ...
    def print_metrics(self):
        ...
        print("\n" + "=" * 60)
        print("KYBER-512 PERFORMANCE METRICS (ARM64)")
        print("=" * 60)
...
def test_system():
    print("\n" + "=" * 60)
    print("KYBER-512 + AES-256-GCM BASELINE TEST")
    print("Architecture: ARM64 (AWS t4g.micro)")
    print("=" * 60)
    print()
    
    crypto = Kyber512Baseline()
    
    print("Step 1: Generating Kyber-512 keypair...")
    ...
    print("\n✓ Kyber-512 baseline test complete!")
    print("=" * 60)
